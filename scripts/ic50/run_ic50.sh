        ...
        do
			...
			do
			    ...
			    do
                            		...
                            		bsub -q gpuqueue -n 2 -gpu "num=1:j_exclusive=yes" -R "rusage[mem=8] span[hosts=1]" -W 15:00 -o "logs_$name.stdout" -eo "logs_$name.stderr" \
			    		...
			    		--normalize $normalize --time_limit "14:00" --filter_outliers --fix_seed --seed $seed --output "/data/chodera/retchinm/pIC50"
			    done
	    	        done
                    done
                done
