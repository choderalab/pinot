...
def run(args):
    ...
    batched_train_data = pinot.data.utils.batch(train_data,
            args.batch_size_gen)
    ...
    logs.info("Done training and testing, saving the model state dictionary and results ...")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer', type=str, default='GraphConv', help="Type of graph convolution layer")
    ...
    parser.add_argument('--background_data', type=str, default="zinc_tiny", help="Background data to pre-train generative model on")
    parser.add_argument('--n_epochs_generative', type=int, default=50, help="Number of epochs of generative model pre-training")
    parser.add_argument('--batch_size_gen', type=int, default=32, help="Batch size for training generative model")
    parser.add_argument('--optimizer_generative', type=str, default="adam", help="Optimizer for generative model pre-training")
    parser.add_argument('--lr_generative', type=float, default=1e-4, help="Learning rate for generative model pre-training")
    parser.add_argument('--split', type=float, nargs='+', default=[0.9, 0.1], help="Training-testing data split")
