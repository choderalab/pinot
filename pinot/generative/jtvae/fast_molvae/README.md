...
For example, to perform tree decomposition over a set of molecules, run
```
python pinot/generative/jtvae/fast_jtnn/mol_tree.py --smiles /pinot/data/zinc/all.txt --vocab_out pinot/data/zinc/vocab_all.txt
```
