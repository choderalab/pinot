...
from pinot.generative.torch_jtvae.fast_jtnn.nnutils import *
from pinot.generative.torch_jtvae.fast_jtnn.chemutils import get_mol
...
def bond_features(bond):
    ...
    fbond = list([bt == Chem.rdchem.BondType.SINGLE, bt == Chem.rdchem.BondType.DOUBLE, bt == Chem.rdchem.BondType.TRIPLE, bt == Chem.rdchem.BondType.AROMATIC, bond.IsInRing()])
