...
class GPytorchVariationalGaussianProcessRegressor(GaussianProcessRegressor):
    """ GPytorch implementation of vgp.
    """
    ...
    def __init__(self,
                 ...
                 num_data=1,
                 kernel=None):
        super(GPytorchVariationalGaussianProcessRegressor, self).__init__()
